...
| --------------------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ID**                      | `object`  | Unique identifier for each record (e.g., `A0000011`).                                                                                                                                               |
...
| **SIDE**                    | `object`  | Indicates the TIGER/Line side of the street (`L` = left, `R` = right).                                                                                                                              |
...
| **AVG_RATE**                | `float64` | Freddie Mac 30-year fixed mortgage rate associated with the sale around the **closing** date (weekly or monthly average).                                                                           |
| **RATE_METHOD**             | `object`  | Indicates how the rate was assigned — `THURSDAY_BEFORE` (weekly) or `MONTHLY_AVERAGE` (fallback when specific closing date was unavailable).                                                        |
